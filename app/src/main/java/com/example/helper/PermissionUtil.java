...
public class PermissionUtil {
    ...
    public static final int REQUEST_WRITE_CONTACTS = 3;
    public static final int REQUEST_CONTACTS = 4;
    ...
    public static boolean hasReadContactsPermission(Activity activity){
        int hasPermission = ContextCompat.checkSelfPermission(activity,
                Manifest.permission.WRITE_CONTACTS);
        if(!permissionExists(Manifest.permission.WRITE_CONTACTS)){
            Log.e("permission","your system does not suppport"+Manifest.permission.WRITE_CONTACTS+" permission");
            return false;
        }
        if (hasPermission != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(activity,
                    new String[]{Manifest.permission.WRITE_CONTACTS},
                    PermissionUtil.REQUEST_WRITE_CONTACTS);
            return false;
        }
        return true;
    }
